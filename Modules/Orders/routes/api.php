...
Route::middleware(['auth:sanctum'])->prefix('v1/admin')->group(function () {
    ...
    Route::post('/active-reservations', [OrdersController::class, 'getActiveReservationsAdmin']);
...
Route::middleware(['auth:sanctum'])->prefix('v1/front')->group(function () {
    ...
    Route::get('/active-reservations', [OrdersController::class, 'getActiveReservations']);
